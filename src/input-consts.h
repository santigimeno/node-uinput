#ifndef __INPUT_CONSTS_H__
#define __INPUT_CONSTS_H__
...
const InputConst kInputConsts[] = {
    ...
    { "EV_UINPUT", EV_UINPUT },
    { "UI_FF_UPLOAD", UI_FF_UPLOAD },
    { "UI_FF_ERASE", UI_FF_ERASE },
    { "UINPUT_MAX_NAME_SIZE", UINPUT_MAX_NAME_SIZE }
};

#endif // __INPUT_CONSTS_H__
